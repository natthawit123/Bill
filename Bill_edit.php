            ...
            <div class="box box-primary collapse1" id="show_addmember">
              ...
              <div class="box-body">                  
                  <div class="form-group col-md-8">
                    ...
                    <input type="text" class="form-control"  placeholder="ชื่อโครงการ"name="projact_bill" value="<?php echo $row['projact_bill'];?>">
                  </div>
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control"  placeholder="ชื่อลูกค้า/หน่วยงาน"name="namecus_bill" value="<?php echo $row['namecus_bill'];?>">
                  </div>
                  ...
                  <label>ที่อยู่</label>
                  <textarea class="textarea form-group"  name="address_bill" placeholder="ที่อยู่ลูกค้า" style="width: 100%; height: 100px;border: 1px solid #dddddd;"value=""><?php echo $row['address_bill'];?></textarea>
                   </div>    
